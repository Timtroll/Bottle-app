...
my $paws = Paws->new(config => { credentials => {
        access_key	=> '123AJQQGEYEGRQMNI6FA',
        secret_key	=>	'123TVF7sBfMzQa7Osqoe8da35y/bE3Ef9pWZF6gk'
}, region => 'eu-west-1' });
...
$glacier = Net::Amazon::Glacier->new(
        'us-west-1',
        '123AJQQGEYEGRQMNI6FA',
        '123TVF7sBfMzQa7Osqoe8da35y/bE3Ef9pWZF6gk',
);
 
my $vault = 'Test';

$archive_id = '123kBdVfS-JswxokGi5TX7DvzCD5fCues-b27FyZfcF5Dei9KN-KwL3tvuh0wvo2_bX8nz5q6JA_eySVzb4O58Z03v8Dxd_N_LwVAAFeYzlmtVtRcex7phLiUCFsD1MmwNyovEpS0g';
